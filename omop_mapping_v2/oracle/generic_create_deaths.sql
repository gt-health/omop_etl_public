...
*/
create or replace
procedure      omop.generic_create_deaths( p_loadid number )
    ...
    begin
         ...
         etl.logm('generic_create_deaths', 'generic_create_deaths' , 'START' );
        v_loadid := p_loadid;
          ...
          etl.logm('generic_create_deaths', 'insert into death' , rowcnt );

          etl.logm('generic_create_deaths', 'generic_create_deaths' , 'FINISH' );
