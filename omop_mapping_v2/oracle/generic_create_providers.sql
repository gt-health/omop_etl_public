...
create or replace procedure omop.generic_create_providers( v_loadid int)
...
begin
    ...
    etl.logm('generic_create_providers', 'generic_create_providers' , 'START' );
    ...
    select
        omop.provider_id_seq.nextval as provider_id,
...
and prov.load_id = coalesce(v_loadid, prov.load_id )
    ...
    ;
      ...
      etl.logm('generic_create_providers', 'insert into provider' , rowcnt );

      etl.logm('generic_create_providers', 'generic_create_providers' , 'FINISH' );
